...
const TruckScheduling = (props) => {
  return (
    <div className="truck-scheduling-container1">
      <Helmet>
        <title>Truck-Scheduling - Sophisticated Quizzical Wasp</title>
        <meta
          property="og:title"
          content="Truck-Scheduling - Sophisticated Quizzical Wasp"
        />
      </Helmet>
  ...
  checkMobileMenu()
      ...
      <a href="https://play.teleporthq.io/signup">
        <div
          ...
          className="truck-scheduling-container6"
        >
          <svg
            width="24"
            height="24"
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="truck-scheduling-icon90"
          >
            <path
